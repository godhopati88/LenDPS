...
Public Class Client
    Private _Connection As ConnectionInfoClient
    ...
    Private Sub ConnectButton_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ConnectButton.CheckedChanged
        If ConnectButton.Checked Then
            If _ServerAddress IsNot Nothing Then
                ConnectButton.Text = "Disconnect"
                'ConnectButton.Image = My.Resources.Disconnect
                Try
                    _Connection = New ConnectionInfoClient(_ServerAddress, CInt(PortTextBox.Text), AddressOf InvokeAppendOutput)
    ...
    Private Sub ServerTextBox_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles ServerTextBox.Validating
